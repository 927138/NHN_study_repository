    ...
    <main>
        <div class="album py-5 bg-light">
            <div class="container">
                        ...
                        <div class="col">
                            <div class="card shadow-sm">
                                <svg class="bd-placeholder-img card-img-top" width="100%" height="225"
                                    ...
                                    <text x="50%" y="50%" fill="#eceeef" dy=".3em">${product.productImage}</text>
                                </svg>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <small class="text-muted"> 상품명 ${product.modelName}</small>
                                        <small class="text-muted"> 가격 ${product.unitCost}</small>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <c:forEach begin="${start}" end="${finish}" var="index">
                    <c:choose>
                        <c:when test="${page.pageable.pageNumber+1 == index}">
                            <a href="/productPaging?&page=${index-1}">${index}</a>
                        </c:when>
                        <c:otherwise>
                            <a href="/productPaging?page=${index-1}">${index}</a>
                        </c:otherwise>
