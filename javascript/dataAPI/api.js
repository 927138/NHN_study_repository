...
window.addEventListener("DOMContentLoaded",async function(){
   ...
   const validateForm = function(form){
       ...
       console.log(departureIdValue + ", " + arrivalIdValue);
      if(departureIdValue == null || departureIdValue == undefined ||
        arrivalIdValue == null || arrivalIdValue == undefined ||
        departureIdValue === arrivalIdValue){
        alert("출발/도착지가 같음");
        return false;
      }
      return true;
