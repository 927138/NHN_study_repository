...
class StatementUserRepositoryTest {
     ...
     @BeforeAll
     static void setUp() {
          userRepository = new UserStatementRepository();
     ...
     void findByUserIdAndUserPassword() {
          ...
          Assertions.assertAll(
                  ...
                  ()->Assertions.assertEquals(userOptional.get().getId(),id),
                  ()->Assertions.assertEquals(userOptional.get().getPassword(),password)
          );
     }
     ...
     void findByUserIdAndUserPAssword_sql_injection(){
          ...
          log.debug("userId:{}",userOptional.get().getId());
          log.debug("userName:{}",userOptional.get().getName());
          log.debug("userPassword:{}",userOptional.get().getPassword());
     ...
     void save() {
          ...
          Assertions.assertAll(
                  ...
                  ()->{
                       ...
                       Assertions.assertAll(
                               ()->Assertions.assertTrue(userOptional.isPresent()),
                               ()->Assertions.assertEquals(userOptional.get().getId(),newUser.getId()),
                               ()->Assertions.assertEquals(userOptional.get().getName(),newUser.getName()),
                               ()->Assertions.assertEquals(userOptional.get().getPassword(),newUser.getPassword())
                       );
                  }
          );
     }
     ...
     void updateUserPasswordByUserId() {
          ...
          Assertions.assertAll(
                  ()->Assertions.assertTrue(userOptional.isPresent()),
                  ()->Assertions.assertEquals(userOptional.get().getId(),id),
                  ()->Assertions.assertEquals(userOptional.get().getPassword(),newPassword)
          );
     }
